...
export const Definitions = {
  ...
  "app.heap_snapshot": keybind("none", "Write heap snapshot"),
  ...
  "session.child.first": keybind("down,<leader>down", "Toggle subagent picker"),
  ...
  "session.first": keybind("ctrl+g,home", "Navigate to first message"),
  ...
  "session.messages_last_user": keybind("none", "Navigate to last user message"),
