...
const icons = {
  ...
  quote: {
    viewBox: "0 0 16 16",
    body: `<path d="M5.2 11.5C5.2 11.5 8 11.5 8 7.5V3.5H3.5V7.5C3.5 7.5 5.2 7.5 5.2 9C5.2 10 4.2 10.5 3.5 10.5V11.5H5.2ZM11.2 11.5C11.2 11.5 14 11.5 14 7.5V3.5H9.5V7.5C9.5 7.5 11.2 7.5 11.2 9C11.2 10 10.2 10.5 9.5 10.5V11.5H11.2Z" fill="currentColor"/>`,
  },
}
